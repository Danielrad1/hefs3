...
interface FolderCustomizationModalProps {
  visible: boolean;
  folderName: string;
  currentMetadata: FolderMetadata | null;
  onSave: (updates: Partial<Omit<FolderMetadata, 'folderName'>>) => void;
  onClose: () => void;
}

// Icon categories - 200+ icons total, folder-focused
const ICON_CATEGORIES = {
  Folders: [
    'folder', 'folder-open', 'folder-outline', 'folder-open-outline',
    'albums', 'albums-outline', 'archive', 'archive-outline',
    'file-tray-full', 'file-tray-full-outline', 'file-tray', 'file-tray-outline',
    'briefcase', 'briefcase-outline', 'business', 'business-outline',
    'documents', 'documents-outline', 'layers', 'layers-outline'
  ],
  Education: [
...
export default function FolderCustomizationModalV2({
  visible,
  folderName,
  currentMetadata,
  onSave,
